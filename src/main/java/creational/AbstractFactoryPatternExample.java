...
// Create an abstract class (i.e AbstractFactory) to get the factories for Bank
// and Loan Objects.
...
// Create a FactoryCreator class to get the factories by passing an information
// such as Bank or Loan.
...
class AbstractFactoryPatternExample {
	...
	public static void main(String args[]) throws IOException {
		...
		// get an object of Bank and call its method getBank().But we want to get one
		// bank at time not all.for this we IO concept.
